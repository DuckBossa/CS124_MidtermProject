...
public class DeleteFrame extends JFrame{
	...
	public DeleteFrame( Eminem database, Main window ){
		...
		enter.addActionListener(new DeleteRow());
	...
	public void setTableOne (int curId) {
		...
		sizeField.setText(cur.columns.get(3));
	...
	class DeleteRow implements ActionListener {
		public void actionPerformed (ActionEvent ae) {
			...
			if(table.equals("MMPack")) {
				...
				database.deleteRow(database.tables.get("Sales"), country);
			}
